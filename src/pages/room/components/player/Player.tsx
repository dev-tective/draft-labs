...
import { Player as PlayerType } from "@/stores/teamStore";
import { useDeletePlayer } from "@/hooks/usePlayer";
    ...
    return (
        ...
        >
            ...
            <div className="h-15 aspect-square overflow-hidden bg-white">
                <img
                    src={player.profile_url || DEFAULT_IMAGE}
                    alt={player.nickname}
            ...
            <div className="flex items-center flex-col md:flex-row gap-2 ml-auto text-slate-200">
                ...
                <button
                    ...
                    className={`transition-colors hover:opacity-80 ${sensorColor}`}
                >
